      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-menubuilder">
          <ul class="nav navbar-nav navbar-left">
            <li><a href="memberarea2.php">Home</a>
            </li>
          ...
          <li><a href="profile2.php"><span class="glyphicon glyphicon-user"></span> Profile</a>
            </li>
            <li><a href="logout2.php"><span class="glyphicon glyphicon-log-out"></span> Logout (<?php echo $_SESSION['user']?>)</a>
            </li>
          </ul>
        </div>
      </div>
