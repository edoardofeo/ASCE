        ...
        <!--
         <div style="display: flex;">
            ...
            <div>
                ...
                <tr><td> <span><input type="text" size="20%" name="name"  placeholder=""  id="form_name" ></span> </td></tr>
                <tr><td> <div class="error_form" id="name_error_msg"> </div> </td></tr>


                <tr><td> <label>Surname</label> </td></tr>
                <tr><td> <span><input type="text" size="20%" name="surname"  placeholder=""  id="form_surname" ></span> </td></tr>
                <tr><td> <div class="error_form" id="surname_error_msg"> </div> </td></tr>

               <tr><td> <label>Nationality</label> </td></tr>
               <tr><td> <select size="1.2%" name="nation"  placeholder=""  id="form_nation">
               ...
               <tr><td> <div class="error_form" id="nation_error_msg"> </div> </td></tr>
